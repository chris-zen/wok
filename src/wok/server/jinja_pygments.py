...
#
# https://github.com/larrymyers/python-utils/blob/master/pygments_extension.py
#
# I couldn't find any information on licensing and how to cite/acknowledge the author.
